...
class Config:
    ...
    SOURCES_KAFKA_HOST = ENVIRONMENT.get_value("SOURCES_KAFKA_HOST", default="localhost")
    SOURCES_KAFKA_PORT = ENVIRONMENT.get_value("SOURCES_KAFKA_PORT", default="29092")
